...
class crud {
	...
	public function update($table,$values,$options=[]) { 
		...
		try {
			...
			//verilerin gelip gelmediğini ekranda kontrol edebilmek için gereken kodlar yazılıp daha sonra yporum satırına alındı//
...
//yüklenen resmin uzantısını almak için yazılan kodlar//
...
/* beni hatırla kısmı için 3. parametre olarak remember_me eklendi ve kodları yazıldı */
			...
			if ($stmt->rowCount()==1) {
				...
				// status kısmı yorum sastırına alındı. Hatalar verildiği için. Kontrollerden sobnra yapabilirsen tekrar etkin hale getir.////
...
public function tDate($date,$options=[]) {
	...
	// Blog sayfasının ve içeriğindeki yazıların düzgün çalışabilmesi için githubtan yardımcı kodlar alındı. (395-451 arası)
