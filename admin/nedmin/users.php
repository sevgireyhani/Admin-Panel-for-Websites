...
<!-- Yönetici (admin) ekleme parçası için panel isimli veritabanının admins isimli tablosuna bağlanılıp verilerle bağlantı sağlantı. Böylece "admins.php" sayfasından istediğimiz yönetici ekleyebileceğiz ve bilgilerimiz veritabanımıza kopyalanacak. -->
 ...
 ?>
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="row">
            <div class="col-xs-12">
              <img width="200" src="dimg/users/<?php echo $row['users_file'] ?>">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
         ...
         <!--   Bilgileri kaydetmeden önce resimle birlikte önizleyip gözden geçirmemiz gereken kodlar yazıldı -->
